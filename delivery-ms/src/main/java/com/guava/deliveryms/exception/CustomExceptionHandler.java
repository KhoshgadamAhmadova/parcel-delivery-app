...
import com.guava.deliveryms.dto.resp.ErrorResponseDto;
...
public class CustomExceptionHandler {
    ...
    public static final String NOT_ACCESSIBLE_MSG = "Data access denied!";
    public static final String ILLEGAL_OPERATION_MSG = "Operation not allowed!";
    ...
    @ExceptionHandler(DatNotAccessibleException.class)
    public final ResponseEntity<Object> handleDatNotAccessibleException(Exception ex, WebRequest request) {
        String errorDetail = ex.getMessage();
        return getError(FORBIDDEN, NOT_ACCESSIBLE_MSG, errorDetail, ex, request);
    }

    @ExceptionHandler(IllegalOperationException.class)
    public final ResponseEntity<Object> handleIllegalOperationException(Exception ex, WebRequest request) {
        String errorDetail = ex.getMessage();
        return getError(BAD_REQUEST, ILLEGAL_OPERATION_MSG, errorDetail, ex, request);
    }
